...
<div id="accueil" class="slide">
		...
		<div id="sociaux">
			<div id="fb" class="post"></div>
			<div id="insta" class="post"></div>
			<div id="linkedin" class="post"></div>
			<div id="twiter" class="post"></div>
		</div>
			...
			<div id="presd">
			        ...
			        <div id="texte">
				         ...
				         <p id="pres">
                           ...
                           Je me passionne pour le <b>Japon</b> et de son art culinaire. <b>La photographie</b> et la <b>musique</b> font parties de mes autres passions. La musique est un vecteur dՎmotion qui me sensibilise.  
                         </p>
				    </div>
				...
				<div class="wrapper2">		
					...
					<div id="tout" class="gal-group gal-open">
						...
						/* permet de compter le nombre de travaux ($count) */
                                ...
                                while($don = $req->fetch())
                                {
                                    ...
                                    echo '<a href="detail.php?id='.$don["id"].'">';   
                             ...
                             if ($count > 6) {
								 ...
								 echo '<a href="galerie.php?suite=tout"><img src="logo/arrow.png"></a>';
							 }
                    ...
                    <div id="pao" class="gal-group">
                           ...
                           <?php
							...
							if ($count > 6) {
								echo '<a href="galerie.php?suite=pao"><img src="logo/arrow.png"></a>';
							}
